  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        secureTextEntry
      />
      <Button title={loading ? 'Logging in...' : 'Login'} color="#FF9800" onPress={handleLogin} disabled={loading} />
      <TouchableOpacity style={{ marginTop: 16 }} onPress={() => navigation.navigate('Register')}>
        <Text style={{ color: '#0a2342', fontWeight: 'bold' }}>Don't have an account? Register</Text>
      </TouchableOpacity>
    </View>
  );
};
